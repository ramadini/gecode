...
//  ConstDashedView::splitBlock(Space& home, int idx, int c, unsigned a) {
//    StringDelta d;
//    return x->notify(home, x->splitBlock(home, idx, c, a), d);
//  }
//  
//  forceinline void
//  ConstDashedView::normalize(Space& home) {
//    x->normalize(home);
//  }
//  
//  forceinline SweepIterator<SweepFwd,ConstDashedView>
...
//  
//  forceinline int
//  ConstDashedView::leftmost_unfixed_idx(void) const {
//    assert (!assigned());
...
//  
//  forceinline int
//  ConstDashedView::rightmost_unfixed_idx(void) const {
//    assert (!assigned());
...
//  
//  forceinline int
//  ConstDashedView::smallest_unfixed_idx(void) const {
//    assert (!assigned());
...
//  template <class T>
//  forceinline ModEvent
//  ConstDashedView::equate(Space& home, const T& y) {
//    assert (!assigned());
//    int lbs = lb_sum();
//    long ubs = ub_sum();
//    Matching m[size()];
...
//  ConstDashedView::push(int i, IterY& it) const {
...
//  template <class IterY>
//  forceinline void
//  ConstDashedView::stretch(int i, IterY& it) const {
...
//  
//  forceinline void
//  ConstDashedView::resize(Space& home, Block newBlocks[], int newSize, int U[], 
//                                                                  int uSize) {
...
//  
//  forceinline ModEvent
//  ConstDashedView::nullifyAt(Space& home, int i) {
//    return x->nullifyAt(home, i);
//  }
//  forceinline ModEvent
//  ConstDashedView::lbAt(Space& home, int i, int l) {
//    return x->lbAt(home, i, l);
//  }
//  forceinline ModEvent
//  ConstDashedView::ubAt(Space& home, int i, int u) {
//    return x->ubAt(home, i, u);
//  }  
//  forceinline ModEvent
//  ConstDashedView::baseIntersectAt(Space& home, int idx, const Set::BndSet& S) {
//    return x->baseIntersectAt(home, idx, S);
//  }
//  forceinline ModEvent
//  ConstDashedView::baseIntersectAt(Space& home, int idx, const Block& b) {
//    return x->baseIntersectAt(home, idx, b);
//  }
//  forceinline void
//  ConstDashedView::updateCardAt(Space& home, int i, int l, int u) {
//    x->updateCardAt(home, i, l, u);
//  }
//  forceinline void
//  ConstDashedView::updateAt(Space& home, int i, const Block& b) {
//    x->updateAt(home, i, b);
//  }

...
namespace Gecode { namespace String {
  ...
  class RegExVisitor {
  public:
    virtual void visit(const EmptyEx&) = 0;
    virtual void visit(const ConcatEx&) = 0;
    virtual void visit(const InterEx&) = 0;
    virtual void visit(const UnionEx&) = 0;
    virtual void visit(const StarEx&) = 0;
    virtual void visit(const CharEx&) = 0;
    virtual void visit(const RangeEx&) = 0;
    virtual ~RegExVisitor(void) {}
  };
  ...
  public:
    ...
    // FIXME: post only works in a positive context.
  ...
  public:
    ...
    void accept(RegExVisitor& visitor) const {
      visitor.visit(*this);
    }
  ...
  public:
    ...
    const RegEx& left(void) const { return *lhs; }
    const RegEx& right(void) const { return *rhs; }
    void accept(RegExVisitor& visitor) const {
      visitor.visit(*this);
    }
    void
  ...
  public:
    ...
    const RegEx& expression(void) const { return *base; }
    void accept(RegExVisitor& visitor) const {
      visitor.visit(*this);
    }
    void
  ...
  public:
    ...
    int min_char(void) const { return minS; }
    int max_char(void) const { return maxS; }
    int min_length(void) const { return l; }
    int max_length(void) const { return u; }
    void accept(RegExVisitor& visitor) const {
      visitor.visit(*this);
    }
    void

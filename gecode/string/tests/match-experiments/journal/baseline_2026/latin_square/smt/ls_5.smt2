...
(assert (str.in_re row_0 (re.* (re.range "A" "E"))))
(assert (= (str.len row_0) 5))
(assert (str.in_re col_0 (re.* (re.range "A" "E"))))
(assert (= (str.len col_0) 5))
(assert (str.in_re row_1 (re.* (re.range "A" "E"))))
(assert (= (str.len row_1) 5))
(assert (str.in_re col_1 (re.* (re.range "A" "E"))))
(assert (= (str.len col_1) 5))
(assert (str.in_re row_2 (re.* (re.range "A" "E"))))
(assert (= (str.len row_2) 5))
(assert (str.in_re col_2 (re.* (re.range "A" "E"))))
(assert (= (str.len col_2) 5))
(assert (str.in_re row_3 (re.* (re.range "A" "E"))))
(assert (= (str.len row_3) 5))
(assert (str.in_re col_3 (re.* (re.range "A" "E"))))
(assert (= (str.len col_3) 5))
(assert (str.in_re row_4 (re.* (re.range "A" "E"))))
(assert (= (str.len row_4) 5))
(assert (str.in_re col_4 (re.* (re.range "A" "E"))))
(assert (= (str.len col_4) 5))

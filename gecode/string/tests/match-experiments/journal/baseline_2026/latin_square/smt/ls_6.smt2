...
(assert (str.in_re row_0 (re.* (re.range "A" "F"))))
(assert (= (str.len row_0) 6))
(assert (str.in_re col_0 (re.* (re.range "A" "F"))))
(assert (= (str.len col_0) 6))
(assert (str.in_re row_1 (re.* (re.range "A" "F"))))
(assert (= (str.len row_1) 6))
(assert (str.in_re col_1 (re.* (re.range "A" "F"))))
(assert (= (str.len col_1) 6))

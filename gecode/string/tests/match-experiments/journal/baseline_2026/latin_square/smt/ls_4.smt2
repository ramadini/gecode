...
(assert (str.in_re row_0 (re.* (re.range "A" "D"))))
(assert (= (str.len row_0) 4))
(assert (str.in_re col_0 (re.* (re.range "A" "D"))))
(assert (= (str.len col_0) 4))
(assert (str.in_re row_1 (re.* (re.range "A" "D"))))
(assert (= (str.len row_1) 4))
(assert (str.in_re col_1 (re.* (re.range "A" "D"))))
(assert (= (str.len col_1) 4))

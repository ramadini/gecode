...
'''
PATH = '/home/roberto/Dashed/gecode/gecode/string/tests/match-experiments/journal/shortest_match/results_tot.log'
SOLVERS = ['cvc5', 'z3str', 'z3seq', 'Dashed_ori', 'Dashed_new', 'Dashed_dec']
MIN = True

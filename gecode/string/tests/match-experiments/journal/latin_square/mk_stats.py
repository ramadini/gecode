...
PATH = '/home/roberto/Dashed/gecode/gecode/string/tests/match-experiments/journal/latin_square/results_tot.log'
SOLVERS = ['cvc5', 'Dashed_ori', 'Dashed_dec', 'Dashed_new', 'z3seq']
MIN = False
TIMEOUT = 300
NUM_PROBLEMS = 40 - 2 + 1
...
solv2lab = {
  'cvc5': (r'\textsc{CVC5}', '-^'),
  'Dashed_dec': (r'\textsc{Decomp}', '-.'),
  'Dashed_ori': (r'\textsc{PropDFA}', '-s'),
  'Dashed_new': (r'\textsc{PropNFA}', '-*'),

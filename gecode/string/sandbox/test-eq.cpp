...
//    Position p = push<SweepFwdIterator<StringView>>(b, fwd_it0);
...
//    p = push<SweepFwdIterator<StringView>>(b, fwd_it1);
...
//    p = push<SweepBwdIterator<StringView>>(b, bwd_it0);
...
//    p = push<SweepBwdIterator<StringView>>(b, bwd_it1);
...
//    stretch<SweepBwdIterator<StringView>>(b, bwd_it0);
//    cerr << "\n...to " << *bwd_it0 << endl;
...
//    stretch<SweepBwdIterator<StringView>>(b, bwd_it1);
//    cerr << "\n...to " << *bwd_it1 << endl;
//    assert (*bwd_it1 == Position(3,0));
  ...
  void test06() {
    ...
    StringView b(StringVar(*this, DashedString(*this, Block(*this, CharSet(*this, 'm'), 1 ,2))));
...
//    stretch<SweepFwdIterator<StringView>>(b, fwd_it2);
//    cerr << "\n...to " << *fwd_it2 << endl;
